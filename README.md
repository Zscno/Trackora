...
- 与 ExplorerBlurMica 不兼容，会导致崩溃，目前原因未知。
...
1. 在 Releases 中下载最新版本中名为 `Trackora-[版本号].zip` （ v1.0.0 为 `Trackora-v1.0.0_x64.zip` ）的文件并解压；

1. 双击打开 `Trackora-[版本号].cer` （ v1.0.0 为 `Trackora-v1.0.0_x64.cer` ）文件并点击“安装证书”：
...
1. 双击打开 `Trackora-[版本号].msixbundle` （ v1.0.0 为 `Trackora-v1.0.0_x64.msix` ）文件并点击“安装”。
