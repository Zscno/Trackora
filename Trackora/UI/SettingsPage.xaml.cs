...
namespace Zscno.Trackora.UI
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        private void ContinuousSoundPicker_SelectionChanged(object sender, SelectionChangedEventArgs e) // TODO: 已弃用。
        {
            LocalSettings["ContinuousUsageTimeSound"] = (string)ContinuousSoundPicker.SelectedItem;
        }

        private void ContinuousTest_Click(object sender, RoutedEventArgs e) // TODO: 已弃用。
        {
            Button? button = sender as Button;
            button!.IsEnabled = false;
        ...
        private void EndUsingSoundPicker_SelectionChanged(object sender, SelectionChangedEventArgs e) // TODO: 已弃用。
        {
            LocalSettings["EndUsingTimeSound"] = (string)EndUsingSoundPicker.SelectedItem;
        }

        private void EndUsingTest_Click(object sender, RoutedEventArgs e) // TODO: 已弃用。
        {
            Button? button = sender as Button;
            button!.IsEnabled = false;
        ...
        private void ThemePick_SelectionChanged(object sender, SelectionChangedEventArgs e) // TODO: 待修改。
        {
            LocalSettings["Theme"] = Themes[(string)ThemePicker.SelectedItem];
        }

        private void TotalSoundPicker_SelectionChanged(object sender, SelectionChangedEventArgs e) // TODO: 已弃用。
        {
            LocalSettings["TotalUsageTimeSound"] = (string)TotalSoundPicker.SelectedItem;
        }

        private void TotalTest_Click(object sender, RoutedEventArgs e) // TODO: 已弃用。
        {
            Button? button = sender as Button;
            button!.IsEnabled = false;
